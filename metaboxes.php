...
add_action('add_meta_boxes', 'FactoryMetaboxes000::actionAddMetaboxes');
add_action('admin_enqueue_scripts', 'FactoryMetaboxes000::actionAdminEnqueueScripts');
add_action('save_post', 'FactoryMetaboxes000::actionSavePost');
 ...
 * @since 1.0.0
 */
class FactoryMetaboxes000 {
    
    /**
     * A variable to store metaboxes per type they defined for.
     * 
     * @since 1.0.0
     * @var FactoryMetaboxes000_Metabox[]
     */
     ...
     * @return FactoryMetaboxes000_Metabox
     */
