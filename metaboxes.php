<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes000') ) {

		add_action('add_meta_boxes', 'Wbcr_FactoryMetaboxes000::actionAddMetaboxes');
		add_action('admin_enqueue_scripts', 'Wbcr_FactoryMetaboxes000::actionAdminEnqueueScripts');
		add_action('save_post', 'Wbcr_FactoryMetaboxes000::actionSavePost');
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryMetaboxes000 {

			/**
			 * A variable to store metaboxes per type they defined for.
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryMetaboxes000_Metabox[]
			 */
