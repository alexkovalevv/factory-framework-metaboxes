<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes000_Metabox') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryMetaboxes000_Metabox {
			 ...
			 *
			 * @since 1.0.0
			 * @param Factory000_ScriptList $scripts A set of scripts to include.
			 * @param Factory000_StyleList $styles A set of style to include.
			 * @return void
			 */
