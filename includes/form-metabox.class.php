<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes000_FormMetabox') ) {
		...
		abstract class Wbcr_FactoryMetaboxes000_FormMetabox extends Wbcr_FactoryMetaboxes000_Metabox {
			...
			/**
			 * @var Wbcr_FactoryForms000_MetaValueProvider
			 */
			protected $provider;
			...
			/**
			 * @param null $post_id
			 * @return Wbcr_FactoryForms000_Form
			 */
			private function getForm($post_id = null)
			{
				// creating a value provider
				$this->provider = new Wbcr_FactoryForms000_MetaValueProvider(array(
					'scope' => $this->scope
				));
