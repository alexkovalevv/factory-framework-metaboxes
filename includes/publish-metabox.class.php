<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes000_PublishMetabox') ) {
		/**
		 * A metabox containing the standart Publish/Update button.
		 *
		 * @since 1.0.0
		 */
		class Wbcr_FactoryMetaboxes000_PublishMetabox extends Wbcr_FactoryMetaboxes000_Metabox {

			/**
			 * @param Wbcr_Factory000_Plugin $plugin
			 */
			public function __construct(Wbcr_Factory000_Plugin $plugin = null)
			{
